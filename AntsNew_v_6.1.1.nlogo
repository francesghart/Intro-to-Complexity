...
; For each evaporation-rate value below, run the model five times, and for each run, record the number of ticks it takes until all the food is eaten.
; Then average these five numbers; this is the "average time taken" for this value of evaporation-rate.
; Which value of evaporation-rate below makes the ants quickest (on average) to each all the food?
